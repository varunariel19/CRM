...
namespace ArielCRM.Infrastructure.Migrations
{
    ...
    [Migration("20260723121922_UpdatedFolderFileTable")]
    partial class UpdatedFolderFileTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.DocumentFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IAccessibleByEveryone")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsDeletedAsRoot")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.Folder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Folders", t =>
                        {
                            t.HasCheckConstraint("CK_Folder_ParentOrDrive", "(\"ParentFolderId\" IS NOT NULL AND \"RootDriveId\" IS NULL) OR (\"ParentFolderId\" IS NULL AND \"RootDriveId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.NotificationRecipient", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.RootDrive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.TeamMessageKey", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.TicketHistory", b =>
                {
                    ...
                    b.Property<string>("CommitedById")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("commited_by_id");
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.UserEncryptionKey", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.ToTable("user_encryption_keys");
                });
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.DocumentFile", b =>
                {
                    b.HasOne("ArielCRM.DataLayer.Entities.Folder", "Folder")
                        .WithMany("Files")
                        .HasForeignKey("FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArielCRM.DataLayer.Entities.User", "UploadedBy")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.Folder", b =>
                {
                    b.HasOne("ArielCRM.DataLayer.Entities.Folder", "ParentFolder")
                        .WithMany("ChildFolders")
                        .HasForeignKey("ParentFolderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ArielCRM.DataLayer.Entities.RootDrive", "Drive")
                        .WithMany("Folders")
                        .HasForeignKey("RootDriveId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.NotificationRecipient", b =>
                {
                    b.HasOne("ArielCRM.DataLayer.Entities.Notification", "Notification")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.Project", b =>
                {
                    ...
                    b.HasOne("ArielCRM.DataLayer.Entities.Contact", null)
                        .WithOne("Project")
                        .HasForeignKey("ArielCRM.DataLayer.Entities.Project", "ContactId1");
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.TicketHistory", b =>
                {
                    b.HasOne("ArielCRM.DataLayer.Entities.User", "CommitedBy")
                        .WithMany("TicketHistory")
                        .HasForeignKey("CommitedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArielCRM.DataLayer.Entities.UserEncryptionKey", b =>
                {
                    b.HasOne("ArielCRM.DataLayer.Entities.User", "User")
                        .WithOne("EncryptionKey")
                        .HasForeignKey("ArielCRM.DataLayer.Entities.UserEncryptionKey", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
